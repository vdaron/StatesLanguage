...
namespace StatesLanguage.Model.States
{
    public abstract class ParameterState : TransitionState, IParametersState
    {
        ...
        /// <summary>
        /// MUST be a Payload Template which is a JSON object, whose input is the result of applying the InputPath to the raw input.
        /// If the "Parameters" field is provided, its payload, after the extraction and embedding, becomes the effective input.
        /// </summary>
