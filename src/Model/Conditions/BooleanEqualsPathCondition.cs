...
namespace StatesLanguage.Model.Conditions
{
    ...
    public sealed class BooleanEqualsPathCondition : BinaryConditionPath
    {
        ...
        [JsonProperty(PropertyNames.BOOLEAN_EQUALS_PATH)]
        ...
        /// </summary>
        public sealed class Builder : IBinaryConditionPathBuilder<Builder, BooleanEqualsPathCondition>
        {
            ...
            public string Type => PropertyNames.BOOLEAN_EQUALS_PATH;
