...
namespace StatesLanguage.Model.Conditions
{
     ...
     * @see Choice
     */
    public sealed class NumericGreaterThanCondition<T> : IBinaryCondition<T>
        where T : IComparable<T>
    {
        private NumericGreaterThanCondition()
        {
        }
         ...
         */
        public sealed class Builder : IBinaryConditionBuilder<Builder, NumericGreaterThanCondition<T>, T>
        {
            ...
            public string Type => PropertyNames.NUMERIC_GREATER_THAN;
