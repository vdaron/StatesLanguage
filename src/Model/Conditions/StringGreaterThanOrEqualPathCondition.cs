...
namespace StatesLanguage.Model.Conditions
{
     ...
     * @see Choice
     */
    public sealed class StringGreaterThanOrEqualPathCondition : BinaryConditionPath
    {
        private StringGreaterThanOrEqualPathCondition():base(Operator.Gte, JTokenType.String, JTokenType.Guid, JTokenType.Uri)
        {
        }

        [JsonProperty(PropertyNames.STRING_GREATER_THAN_EQUALS_PATH)]
         ...
         */
        public sealed class Builder : IBinaryConditionPathBuilder<Builder,StringGreaterThanOrEqualPathCondition>
        {
            private string _expectedValuePath;
            
            private string _variable;

            public string Type => PropertyNames.STRING_GREATER_THAN_EQUALS_PATH;
             ...
             */
            public StringGreaterThanOrEqualPathCondition Build()
            {
                return new StringGreaterThanOrEqualPathCondition
                       {
                           Variable = _variable,
