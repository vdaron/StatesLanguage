...
namespace StatesLanguage.Model.Conditions
{
     ...
     * @see Choice
     */
    public sealed class TimestampLessThanOrEqualPathCondition : BinaryConditionPath
    {
        private TimestampLessThanOrEqualPathCondition():base(Operator.Lte, JTokenType.Date, JTokenType.TimeSpan)
        {
        }

        [JsonProperty(PropertyNames.TIMESTAMP_LESS_THAN_EQUALS_PATH)]
         ...
         */
        public sealed class Builder : IBinaryConditionPathBuilder<Builder, TimestampLessThanOrEqualPathCondition>
        {
            ...
            public string Type => PropertyNames.TIMESTAMP_LESS_THAN_EQUALS_PATH;
             ...
             */
            public TimestampLessThanOrEqualPathCondition Build()
            {
                return new TimestampLessThanOrEqualPathCondition
                       {
                           Variable = _variable,
