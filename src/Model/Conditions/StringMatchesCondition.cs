...
namespace StatesLanguage.Model.Conditions
{
     ...
     * @see Choice
     */
    public sealed class StringMatchesCondition : BinaryCondition<string>
    {
        private StringMatchesCondition():base(Operator.Match)
        {
        }
         ...
         */
        public sealed class Builder : IBinaryConditionBuilder<Builder, StringMatchesCondition, string>
        {
            private string _expectedValue;
            private string _variable;

            public string Type => PropertyNames.STRING_MATCHES;
            ...
            {
                return new StringMatchesCondition
                       {
                           Variable = _variable,
