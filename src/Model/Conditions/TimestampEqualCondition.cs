...
namespace StatesLanguage.Model.Conditions
{
     ...
     * @see Choice
     */
    public sealed class TimestampEqualCondition : BinaryCondition<DateTime>
    {
        private TimestampEqualCondition():base(Operator.Eq)
        {
        }

        [JsonProperty(PropertyNames.TIMESTAMP_EQUALS)]
         ...
         */
        public sealed class Builder : IBinaryConditionBuilder<Builder, TimestampEqualCondition, DateTime>
        {
            ...
            public string Type => PropertyNames.TIMESTAMP_EQUALS;
             ...
             */
            public TimestampEqualCondition Build()
            {
                return new TimestampEqualCondition
                       {
                           Variable = _variable,
