...
namespace StatesLanguage.Model.Conditions
{
    ...
    public sealed class StringLessThanOrEqualCondition : BinaryCondition<string>
    {
         ...
         */
        public sealed class Builder : IBinaryConditionBuilder<Builder, StringLessThanOrEqualCondition, string>
        {
            private string _expectedValue;
            private string _variable;

            public string Type => PropertyNames.STRING_LESS_THAN_EQUALS;
            ...
            {
                return new StringLessThanOrEqualCondition
                {
                    Variable = _variable,
