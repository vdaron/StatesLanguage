...
namespace StatesLanguage.Model.Conditions
{
     ...
     * @see Choice
     */
    public sealed class StringLessThanPathCondition : BinaryConditionPath<string>
    {
        private StringLessThanPathCondition():base(Operator.Lt)
        {
        }

        [JsonProperty(PropertyNames.STRING_LESS_THAN_PATH)]
        ...
        public sealed class Builder : IBinaryConditionPathBuilder<Builder,StringLessThanPathCondition>
        {
            ...
            public string Type => PropertyNames.STRING_LESS_THAN_PATH;
