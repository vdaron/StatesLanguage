...
namespace StatesLanguage.Model.Conditions
{
    ...
    public sealed class NumericLessThanOrEqualPathCondition : BinaryConditionPath
    {
        ...
        [JsonProperty(PropertyNames.NUMERIC_LESS_THAN_EQUALS_PATH)]
         ...
         */
        public sealed class Builder : IBinaryConditionPathBuilder<Builder, NumericLessThanOrEqualPathCondition>
        {
            ...
            public string Type => PropertyNames.NUMERIC_LESS_THAN_EQUALS_PATH;
