...
namespace StatesLanguage.Model.Conditions
{
    ...
    ///     <see cref="Choice" />
    /// </summary>
    public sealed class IsPresentCondition : IBinaryCondition
    {
        private IsPresentCondition()
        {
        }
        ...
        /// <returns>Builder instance to construct a <see cref="IsPresentCondition" /></returns>
        ...
        /// </summary>
        public sealed class Builder : IBinaryConditionBuilder<Builder, IsPresentCondition, bool>
        {
            ...
            public string Type => PropertyNames.IS_PRESENT;
