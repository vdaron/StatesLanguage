...
namespace StatesLanguage.Conditions
{
    ...
    public sealed class TimestampLessThanPathCondition : BinaryConditionPath
    {
         ...
         */
        public sealed class Builder : IBinaryConditionPathBuilder<Builder, TimestampLessThanPathCondition>
        {
            ...
            public string Type => PropertyNames.TIMESTAMP_LESS_THAN_PATH;
