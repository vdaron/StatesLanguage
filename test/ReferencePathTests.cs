...
namespace StatesLanguage.Tests
{
    public class ReferencePathTests
    {
        ...
        {
            ReferencePath path = ReferencePath.Parse("$");
        ...
        {
            ReferencePath path = ReferencePath.Parse(test);
        ...
        {
            ReferencePath path = ReferencePath.Parse("$[12]");
            Assert.Single(path.Parts);
        ...
        {
            ReferencePath path = ReferencePath.Parse("$[12][10]");
