...
namespace StatesLanguage.Tests.IntrinsicFunctions
{
    public class FormatIntrinsicFunctionTests
    {
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format('value')");
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format($.p)");
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format('hello {}','world')");
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format('hello {}',12.34)");
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format('hello {}', null)");
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format('hello {}', $.p)");
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format('hello {}', States.Format('world'))");
        ...
        {
            IntrinsicFunction f = IntrinsicFunction.Parse("States.Format('hello \\\\{\\\\}')");
